            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav" style="background: #faebcd">
                    <ul id="sidebarnav">
                        ...
                        <li class="{{{(Request::is('pelanggan') ? 'active' : '')}}}"> <a href="{{URL('pelanggan')}}" aria-expanded="false"><i class="fa fa-tachometer"></i>h </a></li>
                        <li class="{{{(Request::is('pelanggan/reservasi') ? 'active' : '')}}}"> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-envelope"></i><span class="hide-menu">Sepatu</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="{{URL('pelanggan/reservasi')}}">vans</a></li>
                                <li><a href="{{URL('pelanggan/reservasi/create')}}">adidas</a></li>
                            </ul>
                        </li>
                        <li class="{{{(Request::is('pelanggan/pemesanan') ? 'active' : '')}}}"> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-list-ul"></i><span class="hide-menu">Merchandise</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="{{URL('pelanggan/pemesanan')}}">Baju</a></li>
                                <li><a href="{{URL('pelanggan/pemesanan/create')}}">Sticker</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="{{{(Request::is('pelanggan/pengaturan') ? 'active' : '')}}}"> <a href="{{URL('pelanggan/pengaturan')}}" aria-expanded="false"><i class="fa fa-user"></i>Contact</a></li>
                    </ul>
                </nav>
